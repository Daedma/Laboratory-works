...
public class LinkedListTabulatedFunction implements TabulatedFunction, Serializable {
	...
	public java.util.Iterator<FunctionPoint> iterator() {
		return new Iterator<FunctionPoint>() {
			private FunctionNode position = _head;

			public boolean hasNext() {
				return position._next != _head;
			}

			public FunctionPoint next() {
				if (!hasNext())
					throw new NoSuchElementException("Out of containers borders");
	...
	static public class LinkedListTabulatedFunctionFactory implements TabulatedFunctionFactory {
		public TabulatedFunction createTabulatedFunction(FunctionPoint[] values) throws IllegalArgumentException {
