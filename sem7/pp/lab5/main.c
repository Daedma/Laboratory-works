...
int main() {
  ...
  cudaMemcpy(h_A, d_A, nr_rows_A * nr_cols_A * sizeof(float),
             cudaMemcpyDeviceToHost);
  cudaMemcpy(h_B, d_B, nr_rows_B * nr_cols_B * sizeof(float),
             cudaMemcpyDeviceToHost);
  std::cout << "A =" << std::endl;
  ...
  cudaMemcpy(h_C, d_C, nr_rows_C * nr_cols_C * sizeof(float),
             cudaMemcpyDeviceToHost);
  std::cout << "C =" << std::endl;
